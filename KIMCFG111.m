...
clc;clear;close all;
%Inputs
h=0.02; t(1)=0; tfinal=1000; t=t(1):h:tfinal; N=ceil((tfinal-t(1))/h);
...
a1=0.9;a2=0.8;a3=0.001;a4=0.2;a5=0.5;a6=0.002;a7=0.7;a8=0.4;a10=0.2;b1=5;b2=t(1)-b1;
...
xlabel('Time = t');
ylabel('Compartments');
title('Knee Implant Recovery Dynamicsin the Presence of Delay');
grid on;